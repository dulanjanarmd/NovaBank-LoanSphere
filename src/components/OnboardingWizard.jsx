    ...
    <div className="max-w-3xl mx-auto my-6 glass-panel rounded-2xl shadow-xl rounded-3xl overflow-hidden animate-fade-in">
      ...
      <div className="bg-neutral-900 text-white p-6 flex flex-col md:flex-row md:items-center justify-between border-b border-neutral-800">
        <div>
          ...
          <p className="text-xs text-neutral-400">Apply for a premium savings account with automated biometric e-KYC.</p>
        </div>
        <button
          onClick={() => navigate("/dashboard")}
          className="text-xs font-bold text-error-400 hover:underline mt-2 md:mt-0 transition-all duration-200"
        >
          Cancel Application
        </button>
      </div>
      ...
      <div className="p-6 sm:p-8">
        ...
        {step === 1 && (
          <div className="space-y-4 animate-fade-in">
            <h4 className="text-sm font-bold text-neutral-50 border-b border-neutral-700/30 pb-2 flex items-center gap-2">
              <UserCircle2 className="h-4.5 w-4.5 text-teal-600" /> Confirm Personal Specifications
            </h4>

            <div className="grid sm:grid-cols-2 gap-4 text-xs">
              <div>
                <label className="block text-[11px] font-bold text-neutral-500 mb-1">NIC NUMBER (CONFIRMED)</label>
                <input
                  id="dao-nic"
                  type="text"
                  className="w-full px-3 py-2 border border-neutral-700/50 rounded-xl bg-neutral-900/30 font-mono"
                  value={nicNo}
                  disabled
                />
              </div>
              <div>
                <label className="block text-[11px] font-bold text-neutral-500 mb-1">FULL NAME (PER NIC)</label>
                <input
                  id="dao-name"
                  type="text"
            ...
            <div className="grid sm:grid-cols-2 gap-4 text-xs">
              <div>
                <label className="block text-[11px] font-bold text-neutral-500 mb-1">DATE OF BIRTH</label>
                <input
                  id="dao-dob"
                  type="date"
                  className="w-full px-3 py-2 border border-neutral-700/50 rounded-xl"
              ...
              <div>
                <label className="block text-[11px] font-bold text-neutral-500 mb-1">MOBILE LINK</label>
                <input
                  id="dao-mobile"
                  type="text"
                  className="w-full px-3 py-2 border border-neutral-700/50 rounded-xl bg-neutral-900/30 font-mono"
            ...
            <div className="grid sm:grid-cols-2 gap-4 text-xs">
              <div>
                <label className="block text-[11px] font-bold text-neutral-500 mb-1">EMAIL LINK</label>
                <input
                  id="dao-email"
                  type="email"
                  className="w-full px-3 py-2 border border-neutral-700/50 rounded-xl"
              ...
              <div>
                <label className="block text-[11px] font-bold text-neutral-500 mb-1">OCCUPATION</label>
                <input
                  id="dao-occupation"
                  type="text"
                  className="w-full px-3 py-2 border border-neutral-700/50 rounded-xl"
            ...
            <div className="grid sm:grid-cols-2 gap-4 text-xs">
              <div>
                <label className="block text-[11px] font-bold text-neutral-500 mb-1">SOURCE OF FUNDS</label>
                <select
                  id="dao-funds"
                  className="w-full px-3 py-2 border border-neutral-700/50 rounded-xl"
                  value={fundsSource}
              ...
              <div>
                <label className="block text-[11px] font-bold text-neutral-500 mb-1">EXPECTED MONTHLY TURNOVER (LKR)</label>
                <input
                  id="dao-turnover"
                  type="number"
                  className="w-full px-3 py-2 border border-neutral-700/50 rounded-xl"
            ...
            <div className="text-xs">
              <label className="block text-[11px] font-bold text-neutral-500 mb-1">RESIDENTIAL ADDRESS</label>
              <input
                id="dao-address"
                type="text"
                className="w-full px-3 py-2 border border-neutral-700/50 rounded-xl"
        ...
        {step === 2 && (
          <div className="space-y-6 animate-fade-in text-xs">
            ...
            <div className="grid sm:grid-cols-2 gap-6">
              {/* NIC Scan Input */}
              <div className="bg-neutral-900/30 border-2 border-dashed border-neutral-700/50 rounded-2xl p-4 text-center space-y-2">
                <Upload className="h-8 w-8 text-neutral-400 mx-auto" />
                <h5 className="font-bold text-neutral-200">Sri Lankan NIC (Front & Back)</h5>
                <p className="text-[10px] text-neutral-400">JPEG/PNG formats, Max 5MB size.</p>
                {nicUploaded ? (
                  <span className="inline-flex bg-success-900/20 text-success-800 py-1 px-2.5 rounded-full font-bold border border-success-200 gap-1 items-center mx-auto text-[10px]">
                  ...
                  <button
                    ...
                    className="px-3 py-1.5 btn-premium rounded-xl text-[10px] font-bold cursor-pointer transition-all duration-200"
                  >
                    Select/Drop File
                  </button>
                )}
              ...
              <div className="bg-neutral-900/30 border-2 border-dashed border-neutral-700/50 rounded-2xl p-4 text-center space-y-2">
                <UserCircle2 className="h-8 w-8 text-neutral-400 mx-auto" />
                <h5 className="font-bold text-neutral-200">Liveness Capture / Selfie</h5>
                <p className="text-[10px] text-neutral-400">Position head inside frame & blink.</p>
                {selfieUploaded ? (
                  <span className="inline-flex bg-success-900/20 text-success-800 py-1 px-2.5 rounded-full font-bold border border-success-200 gap-1 items-center mx-auto text-[10px]">
            ...
            {nicUploaded && selfieUploaded && !kycDone && (
              <div className="text-center pt-2">
                <button
                  ...
                  disabled={loadingKyc}
                  className="px-5 py-2.5 bg-teal-500 hover:bg-teal-600 text-white font-bold rounded-xl shadow-md inline-flex items-center gap-2 cursor-pointer transition-all duration-200"
                >
                  {loadingKyc ? (
                    <>
            ...
            {/* e-KYC Results Panel */}
            {kycDone && (
              <div className="bg-neutral-900/30 border border-neutral-700/50 p-5 rounded-2xl space-y-3.5 animate-fade-in">
                <div className="flex items-center justify-between border-b border-neutral-700/50 pb-2.5">
                  <span className="font-bold text-neutral-200 uppercase font-mono tracking-wider text-[10px]">Verify Result Output</span>
                  <span className="px-2.5 py-0.5 font-bold rounded-full bg-success-900/20 border border-success-200 text-success-800 text-[10px]">KYC STATUS: VERIFIED</span>
                </div>

                <div className="grid sm:grid-cols-2 gap-4">
                  <div className="bg-neutral-900/50 p-3 border border-neutral-700/50/60 rounded-xl space-y-1">
                    <span className="text-neutral-400 text-[10px]">NIC OCR Name Extraction</span>
                    <p className="font-bold text-neutral-50">BANDARA K. KAMAL</p>
                    <span className="text-neutral-400 text-[10px]">DOB Extraction</span>
                    <p className="font-bold text-neutral-50">1992-05-14</p>
                  </div>

                  <div className="bg-neutral-900/50 p-3 border border-neutral-700/50/60 rounded-xl text-center flex flex-col justify-center items-center">
                    <span className="text-neutral-400 text-[10px]">Face Matching Index</span>
                    ...
                    <span className="text-[9px] text-neutral-400 mt-0.5">Biometric match acceptable. Sanctions check: CLEAR.</span>
                  </div>
                </div>
              </div>
            )}
                ...
                <div
                  ...
                  className={`border p-4 rounded-2xl cursor-pointer flex justify-between items-center transition ${
                    selectedProduct === prod.name
                      ? "bg-teal-50/50 border-teal-500 ring-2 ring-teal-500/10 shadow-md shadow-primary/5"
                      : "bg-neutral-900/50 border-neutral-700/50 hover:bg-neutral-900/30"
                  }`}
                >
                  <div className="space-y-1">
                    <h5 className="font-bold text-neutral-50">{prod.name}</h5>
                    <p className="text-[11px] text-neutral-500">{prod.desc}</p>
                    <span className="text-[10px] text-neutral-400 font-mono">Min balance required: {prod.min}</span>
                  </div>
                  <div className="text-right">
                    <span className="text-lg font-bold text-teal-600 font-mono block">{prod.rate}</span>
                    <span className="text-[9px] uppercase font-mono tracking-wider font-bold text-neutral-400 block mt-0.5">Yield Rate</span>
                  </div>
                </div>
              ))}
            </div>
        ...
        {step === 4 && (
          <div className="space-y-4 animate-fade-in text-xs">
            ...
            <div className="bg-neutral-900/30 p-4 border border-neutral-700/50 rounded-2xl max-h-56 overflow-y-auto leading-relaxed text-[11px] text-neutral-300 space-y-2.5">
              <h5 className="font-bold text-neutral-50 text-xs">Sri Lanka Personal Data Protection Act (PDPA) No. 9 of 2022 Consent</h5>
            ...
            <div className="space-y-3 pt-3">
              <label className="flex items-start gap-2.5 cursor-pointer transition-all duration-200">
                <input
                  id="chk-pdpa"
                  type="checkbox"
                  className="mt-0.5 h-4 w-4 text-teal-600 focus:ring-teal-500 border-neutral-300 rounded"
                  checked={pdpaConsent}
        ...
        {step === 5 && (
          <div className="space-y-4 animate-fade-in text-xs">
            ...
            <div className="bg-neutral-900/30 border border-neutral-700/50 rounded-2xl p-5 divide-y divide-neutral-200/60 text-xs">
              ...
              <div className="py-2 flex justify-between">
                <span className="text-neutral-400">Account Owner Name:</span>
                <span className="font-bold text-neutral-50">{fullName}</span>
              </div>
              <div className="py-2 flex justify-between">
                <span className="text-neutral-400">NIC Identifier:</span>
                <span className="font-bold text-neutral-50 font-mono">{nicNo}</span>
              </div>
              <div className="py-2 flex justify-between">
                <span className="text-neutral-400">Contact Number:</span>
                <span className="font-bold text-neutral-50 font-mono">{mobile}</span>
              </div>
              <div className="py-2 flex justify-between">
                <span className="text-neutral-400">Verification Match score:</span>
                <span className="font-bold text-success-600">{matchScore ? `${matchScore}% Match` : "95.0% Pre-Verified"}</span>
              </div>
            </div>

            <div className="bg-success-900/20 border border-success-100 p-4 rounded-xl text-center space-y-1">
              <span className="text-[11px] font-bold text-success-800 flex items-center gap-1 justify-center">
                <ShieldCheck className="h-4 w-4" /> SECURE REGULATORY DISPATCH
              </span>
              <p className="text-[10px] text-success-600 leading-tight">Submitting will trigger a live mock API dispatch to NovaBank's Core Banking System ledger to provision your accounts instantly.</p>
            </div>
          </div>
        )}
        ...
        <div className="flex justify-between pt-6 border-t border-neutral-700/30 mt-8">
          <button
            ...
            className="flex items-center gap-1.5 px-4 py-2 border border-neutral-700/50 text-neutral-300 hover:bg-neutral-900/30 rounded-xl text-xs font-semibold disabled:opacity-40 disabled:hover:bg-transparent cursor-pointer transition"
          >
          ...
          {step < 5 ? (
            <button
              ...
              className="flex items-center gap-1.5 px-5 py-2 bg-neutral-900 hover:bg-neutral-800 text-white rounded-xl text-xs font-bold shadow transition cursor-pointer disabled:opacity-40"
            >
              <span>Next</span>
