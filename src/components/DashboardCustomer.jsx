              ...
              <div className="flex items-center justify-between border-b border-slate-100 pb-3">
                ...
                <div className="flex items-center gap-3">
                  <button
                    ...
                    className="inline-flex items-center gap-1 px-2.5 py-1.5 border border-red-200 bg-red-50 hover:bg-red-100 text-red-700 text-[10px] font-bold rounded-lg cursor-pointer transition shadow-sm"
